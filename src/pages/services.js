...
const Services = (props) => (
        ...
        <div id="main" className="alt">
            <section id="one">
                <div className="inner">
                    ...
                    <span className="image main"><img src={kneePain} alt="" /></span>
    ...
    <Service title="Bone Density">
      <p>Accurate measurements of bone density is often neglected, but extremely important, diagnostic tool.  Thinning of the bones, known as osteoporosis, is a condition that affects all of us as the years go by.</p>
      <p>Whereas most facilities will obtain only two or three density readings, we routinely perform twenty to thirty separate measurements.  Especially important is the lateral view of the lumbar spine, which measures specifically the density of the spinal vertebral bodies.  In most cases, the lowest bone density of anyone’s entire skeleton will be the spinal vertebrae.  It is for this reason that vertebral compression fractures are an extremely common problem often resulting in pain, deformity, disability and often severely altered lifestyle.  Almost no other imaging center routinely measures the vertebral body from the lateral view except for Oakland Orthopedic Partners. We recommend that all bone density patients follow up with Dr. Henderson for a thorough review of the results of the density testing with a customized plan to prevent or perhaps even reverse future osteoporosis.</p>
    </Service>

    <Service title="Back Pain & Injuries">
      <p>Almost everyone experiences a back problem sometime in their life. There are many different causes that may lead to back pain, hip pain, weakness, numbness, or sciatic pain radiating down the leg. It is essential that the proper diagnosis is made first so that proper treatment can be initiated. Especially when it comes to problems of the spine, a problem well defined is three quarters solved. Unfortunately, few practitioners are knowledgeable about properly diagnosing spinal problems.</p>
      <p>At Oakland orthopedic Partners, we are experts in the proper diagnosis of spine and back problems from the neck down to the tailbone. This allows us to treat the problem properly, most often with non operative means. You should know that almost all back pain comes from the spine and not muscles. The most common treatments involve proper posture, body mechanics, activity and lifestyle changes, braces, and injections. Surgical intervention is RARELY necessary!</p>
    </Service>

    <Service title="Shoulder Problems">
      <p>The most movable joint in the body, the shoulder, is also one of the most potentially unstable joints. As a result, it is the site of many common problems. They include sprains, strains, dislocations, separations, tendinitis, bursitis, torn rotator cuffs, frozen shoulder, fractures, and arthritis.</p>
    </Service>
                    </div>

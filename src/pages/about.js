...
const About = props => {
  const data = useStaticQuery(graphql`
    query AboutPage {
      drWithPatient: file(
        relativePath: { eq: "dr-henderson-with-female-patient.jpg" }
      ) {
        ...
        <section id="one">
          <div className="inner">
            ...
            <p>
              ...
              Musculoskeletal System. Orthopedic surgeons implement both
              surgical and nonsurgical expertise to treat musculoskeletal
            ...
            <p>
              ...
              partnership committed to actively improving our patients quality
              of life. Dr. Bruce Henderson is Board Certified by the American
              Board of Orthopedic Surgery and well equipped to handle any and
              all of your orthopedic needs. When you visit our practice, you'll
              meet a team of professionals that includes Dr. Henderson, medical
              assistants, and administrative staff who are focused on you and
              your care.
            </p>
            <p>
              ...
              While some of our patients problems care be treated
              nonoperatively, Dr. Henderson is trained in the latest surgical
            ...
            <p>
              ...
              orthopedics program has been consistently recognized for
              excellence and superior outcomes in orthopedic surgery and joint
              replacement. Our convenient location on Woodward Avenue allows us
              to serve patients from throughout Southeast Michigan and beyond,
              including Waterford, Clarkston, Rochester, Bloomfield, White Lake,
              Farmington, Birmingham, and more.
              <br style={{ clear: 'both' }} />
            </p>
          </div>
        </section>

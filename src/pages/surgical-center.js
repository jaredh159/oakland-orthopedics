...
const About = () => (
  <Layout>
    <Helmet>
      <title>
        Surgical Care Center | Waterford MI Orthopedic Surgery, Total Hip &amp; Total Knee
      </title>
      <meta
        name="description"
      ...
      <section id="one">
        <div className="inner">
          ...
          <p>
            ...
            We are proud to be affiliated with the Waterford Surgery Center, developed by
            local physicians in partnership with St Joseph Mercy Hospital to create a
            state of the art surgical care center. Our surgeons perform most of our
            elective outpatient surgeries and procedures there. Routinely our patients
            return to our office exuberantly pleased with the care they received at the

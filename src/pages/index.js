                ...
                <div id="main">
                    <section id="one" className="tiles">
                        ...
                        <article style={{backgroundImage: `url(${patient})`}}>
                            ...
                            <Link to="/patient-information" className="link primary"></Link>
                        </article>
                        ...
                        <article style={{backgroundImage: `url(${physicalTherapy})`}}>
                            ...
                            <Link to="/physical-therapy" className="link primary"></Link>
                        </article>
                        <article style={{backgroundImage: `url(${surgeryCenter})`}}>
                            ...
                            <Link to="/surgical-center" className="link primary"></Link>
                        </article>
                    </section>
                    <section id="two">
                        <div className="inner">
                            ...
                            <iframe title="Google Map to our Office" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2936.121960181598!2d-83.27878838453555!3d42.616369379170486!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8824bf123b6b18e3%3A0xc29c8a0926eb2720!2sOakland+Orthopedic+Partners!5e0!3m2!1sen!2sus!4v1451415505563&output=embed"width="100%" height="550" frameBorder="0" style={{border: 0}}></iframe>
                        </div>
                    </section>
                </div>
